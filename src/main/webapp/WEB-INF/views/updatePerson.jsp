...
<body>
	...
	<div class="moviesDiv" >
		<springForm:form method="POST" modelAttribute="person" action="/SpringMvcExample/people/updated/${currentPersonId}">
			<h2 class="title">Update Person</h2>
			<c:if test="${not empty personIDtaken}"><div class="error">${personIDtaken}</div><h3 class="spaceBetweenInput"></h3></c:if>
			<springForm:errors class="errorField" path="id" cssClass="error" />
			<h3></h3>
			<springForm:input class="inputField" path="id" placeholder="ID" />
			<h3></h3>
			<springForm:errors class="errorField" path="name" cssClass="error" />
			<h3></h3>
			<springForm:input class="inputField" path="name" placeholder="Name" />
			<h3></h3>
			<springForm:errors class="errorField" path="birth_date" cssClass="error" />
			<h3></h3>
			<springForm:input class="inputField" path="birth_date" placeholder="Birth date" />
			<h3></h3>
			<springForm:errors class="errorField" path="growth" cssClass="error" />
			<h3></h3>
			<springForm:input class="inputField" path="growth" placeholder="Growth" />
			<h3></h3>
			<springForm:errors class="errorField" path="born" cssClass="error" />
			<h3></h3>
			<springForm:input class="inputField" path="born" placeholder="City" />
			<h3></h3>
