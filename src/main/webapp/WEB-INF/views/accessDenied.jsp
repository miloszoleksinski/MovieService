...
<style>
	*{ margin: 0; padding: 0; box-sizing: border-box; }
	...
	h6{ height: 60px; }
	.errorTitle{ padding: 8px; }
	p{ padding: 4px; }
	
	/*  MENU BAR  */
		.menuHeightBig{ height: 40px; }
		.menuHeightResponsive1{ height: 240px; }.menuHeightResponsive2{ height: 200px; }.menuHeightResponsive3{ height: 240px; }
	...
	.errorDiv{ width: 100%; background-color: white; margin: auto; padding-bottom: 20px; text-align: center; }
	.textDiv{ padding: 20px; margin: auto; text-align: center; }
...
<body>
	...
	<div class="errorDiv" >
		<div class="textDiv">
			<h2 class="errorTitle">403 Error - Acces denied</h2>
			<p>Sorry, you do not have permission to acces this page.</p>
		</div>
	</div>
