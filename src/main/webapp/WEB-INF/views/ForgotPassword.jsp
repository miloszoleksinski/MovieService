...
<style>
	*{ margin: 0; padding: 0; box-sizing: border-box;}
	...
	.fullContainer{ background-color: white; text-align: center; padding: 20px 0; width: 100%;}
	.changePassword{border-right: solid 1px black; border-left: solid 1px black; }
 ...
 <body>
	...
	<div class="fullContainer">
		<div class="changePassword">
			<form method="POST" action="sendEmailPassword">
				<h3 class="title">Change password</h3>
				
				<c:if test="${not empty emailSent}"><div class="succes">${emailSent}</div><h3 class="spaceBetweenInput"></h3></c:if>
				<c:if test="${not empty tokenDoesntExists}"><div class="error">${tokenDoesntExists}</div><h3 class="spaceBetweenInput"></h3></c:if>
				<c:if test="${not empty tokenExpired}"><div class="error">${tokenExpired}</div><h3 class="spaceBetweenInput"></h3></c:if>
				
				<p>Email:</p> <input class="inline" type='text' name="email" >
