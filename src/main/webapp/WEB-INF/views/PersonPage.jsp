...
<Style>
		*{ margin: 0; padding: 0; box-sizing: border-box;}
		...
		h6{ height: 60px; }
		.fullContainer{ background-color: white; }
		...
		.personDiv{ width: 80%; background-color: white; margin: auto; height: 600px; display: flex; }
		.personInfo{ padding: 20px;}
		.inline{ display: inline; }
		.personTitle{ font-size: 1.1em; transition: all 0.1s linear 0s; }
		.personTitle:hover{ color: #808080; }
	...
	@media only screen and (max-width: 930px) 
	{
		...
		.fullContainer{ width: 100%; padding: 2%; }
		.personDiv{ width: 90%; text-align: center; height: 100%; } 
		.personInfo{ width: 100%; padding: 2%; margin: auto; }
	}
	...
	<div class="fullContainer">	
		<div class="personDiv" >
			<div class="personInfo">
				<h2><a href="<c:url value="/person/${person.id}"/>" class="personTitle">${person.name}</a></h2>
				<c:if test="${person.growth > 50}">
