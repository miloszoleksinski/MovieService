...
<style>
	*{ margin: 0; padding: 0; box-sizing: border-box;}
	...
	.moviesDiv{ width: 100%; background-color: white; margin: auto; padding: 20px 0; text-align: center;}
	.title{ padding: 11px; }
	...
	<div id="menuBorder">
		<div id="navContainer" class="navContainerBig">
			...
			<div id="userNavbar" class="userNavbarBig">
				<a class="option activelogobutton" title="Become one of us!" href="<c:url value="/register"/>">SignUp</a>
