...
<style>
	*{ margin: 0; padding: 0; box-sizing: border-box; }
	...
	.moviesDiv{ width: 100%; background-color: white; margin: auto; padding-bottom: 40px; text-align: center;}
	.title{ padding: 11px; }
...
<body>
	...
	<div class="moviesDiv" >
		<springForm:form method="POST" modelAttribute="movie" action="/SpringMvcExample/movies/updated/${currentMovieID}">
			<h2 class="title">Update Movie</h2>
			<c:if test="${not empty movieIDtaken}"><div class="error">${movieIDtaken}</div><h3 class="spaceBetweenInput"></h3></c:if>
			<springForm:errors class="errorField" path="id" cssClass="error" />
			<h3></h3>
			<springForm:input class="inputField" path="id" placeholder="ID" />
			<h3></h3>
			<springForm:errors class="errorField" path="title" cssClass="error" />
			<h3></h3>
			<springForm:input class="inputField" path="title" placeholder="Title" />
			<h3></h3>
			<springForm:errors class="errorField" path="year" cssClass="error" />
			<h3></h3>
			<springForm:input class="inputField" path="year" placeholder="Year"/>
			<h3></h3>
			<springForm:errors class="errorField" path="director" cssClass="error" />
			<h3></h3>
			<springForm:input class="inputField" path="director" placeholder="Director"/>
			<h3>Types</h3>
			<springForm:input class="inputField" path="types[${fn:length(types)}]" placeholder="Type"/>
			<h3></h3>
			<springForm:input class="inputField" path="types[${fn:length(types)+1}]" placeholder="Type"/>
			<h3></h3>
			<springForm:input class="inputField" path="types[${fn:length(types)+2}]" placeholder="Type"/>
			<h3>Description</h3>
			<springForm:errors class="errorField" path="description" cssClass="error" />
			<h3></h3>
			<springForm:textarea class="inputField bigInputField" placeholder="Description" path="description" rows="8" cols="70" />
			<h3></h3>
