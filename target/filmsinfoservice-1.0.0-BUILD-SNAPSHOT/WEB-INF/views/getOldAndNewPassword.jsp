...
<style>
	*{ margin: 0; padding: 0; box-sizing: border-box;}
	...
	.fullContainer{ background-color: white; text-align: center; padding: 20px 2%; width: 100%;}
	.spaceBetweenInput{ margin: 6px; }
	.spaceBetweenDiv{ margin: 11px; }
...
<body>
	...
	<div class="fullContainer">
		<div class="changePassword">
			<form method="POST" action="/filmsinfoservice/user/${username}/changedPassword">
				<h3 class="title">Change password</h3>
				<c:if test="${not empty error}"><div class="error">${error}</div><h3 class="spaceBetweenInput"></h3></c:if>
				<c:if test="${not empty passwordDoesntMatch}"><div class="error">${passwordDoesntMatch}</div><h3 class="spaceBetweenInput"></h3></c:if>
				<c:if test="${not empty passwordChanged}"><div class="succes">${passwordChanged}</div><h3 class="spaceBetweenInput"></h3></c:if>
				<p>Old password:</p> <input class="inline" type='password' name="oldPassword" >
				<h3 class="spaceBetweenInput"></h3>
				<p>New password:</p> <input class="inline" type='password' name="newPassword" >
				<h3 class="spaceBetweenInput"></h3>
